...
cur.execute('insert into template (uuid,person_id,person_uuid,database_id,modify_time,file,class_uuid,class_id,sample_uuid,sample_id) \
            ...
            bioverify.template.sample_uuid,sample.sample_id from\
...
')
cur.execute('delete from template where class_id is null')
cur.execute('commit')